...
module.exports = {
  ...
  start: async (Akeno, m, { text, prefix, args }) => {
    ...
    const gif = await axios.get(
      `https://tenor.googleapis.com/v2/search?q=${gifSearchTerm}&key=AIzaSyCmUixUDAtZPb_i80Zjuv2K84AUMc7FSGE&client_key=my_project&limit=12&media_filter=mp4`
    );
    ...
    await Akeno.sendMessage(m.from, buttonMessage, { quoted: m });
  },
};
