module.exports = {
    ...
    start: async(Akeno, m,{pushName,prefix}) => {
        ...
        let yup = ['https://telegra.ph/file/1c333a18f4578c924d78d.mp4',
                    'telegra.ph//file/f58614bfc79c7b23ad4bf.mp4',
                    'telegra.ph//file/efaa47b716fdce4292453.mp4',
...
// 📒 *Guide: https://github.com/ShineiIchijo/Chitoge-Guides* \n\n 
        ...
        await Akeno.sendMessage(m.from,{video:{url:rae}, gifPlayback:true, caption: text},{quoted:m})
